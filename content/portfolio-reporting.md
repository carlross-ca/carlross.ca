...
date: 2026-08-17
draft: false
summary: "Turn brokerage transactions into an accurate, reviewable portfolio record."
---
...
The exact scope depends on the brokerage exports, account structure, transaction volume, and reporting goal.

## Example

My own [public performance record](/performance/) shows the type of output I build: recurring portfolio and benchmark returns, drawdowns, return drivers, risk measures, and monthly PDF records. The accompanying [notes](/notes/) document mistakes, judgment, and process changes.
...
[Discuss a reporting project](/contact/).
